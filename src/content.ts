...
RUNES.push(
 ...
 {id:'flow',  sp:'rune_flow',  nm:{ko:'물결의 룬',en:"Rune of Currents"},
  d:l=>`${X('자동화 주기',"Automation interval")} ×${cutTxt(0.985,l)} → ×${cutTxt(0.985,l+1)}`, apply:(m,l)=>m.autoSpeed*=Math.pow(0.985,l)},
 ...
 {id:'temper',sp:'rune_forge', nm:{ko:'담금질의 룬',en:"Rune of Tempering"},
  d:l=>`${X('장비 효과 지수',"Gear exponent")} ×${powTxt(1.05,l)} → ×${powTxt(1.05,l+1)}`, apply:(m,l)=>m.gearExp*=Math.pow(1.05,l)},
...
SOUL_UPS.push(
 ...
 {id:'s16',sp:'soulforge',    nm:{ko:'혼의 벼림',en:"Soulforge"}, max:Infinity,c:l=>40*Math.pow(2.9,l),
  d:l=>`${X('장비 효과 지수',"Gear exponent")} ×${powTxt(1.2,l)} → ×${powTxt(1.2,l+1)}`, apply:(m,l)=>m.gearExp*=Math.pow(1.2,l)},
);
...
RELIC_UPS.push(
 ...
 {id:'a13',sp:'eternalhand', nm:{ko:'영원한 손길',en:"Eternal Hands"}, max:Infinity,c:l=>11*Math.pow(3.9,l),
  d:l=>`${X('자동화 주기',"Automation interval")} ×${cutTxt(0.85,l)} → ×${cutTxt(0.85,l+1)}`,
...
ETER_UPS.push(
 ...
 {id:'e10',sp:'timeaxis',  nm:{ko:'시간의 축',en:"Axis of Time"}, max:Infinity,c:l=>5*Math.pow(3.2,l),
  d:l=>`${X('자동화 주기',"Automation interval")} ×${cutTxt(0.6,l)} → ×${cutTxt(0.6,l+1)}`,
...
export const REAL_UPS=[
 ...
 {id:'r6', sp:'real_spiral',nm:{ko:'회귀의 나선',en:"Spiral of Return"}, max:Infinity,c:l=>4*Math.pow(3.2,l),
  d:l=>`${X('자동화 주기',"Automation interval")} ×${cutTxt(0.5,l)} → ×${cutTxt(0.5,l+1)}`,
