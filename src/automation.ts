...
export const AUTO_DEFS=[
 ...
 {k:'dungeon', sp:'auto_dungeon',nm:{ko:'던전 연속 탐험',en:"Continuous Delving"},d:()=>X('층을 깬 뒤 멈추지 않고 계속 내려간다',"Keeps descending after each floor"),       unlock:()=>(S.deepestEver||S.deepest)>=20,                    req:()=>X('던전 20층 돌파',"Reach dungeon floor 20")},
